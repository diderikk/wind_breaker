...
Svelte was selected as the UI framework because of its reputation of being lightweight, simple, has Typescript support and was a technology that I wanted to experiment with.', '/dd10071f8d4e0d4feb4a16e89416ccf077455508e169be446c6f03d6cf0c7830.png', 'WebSocket,OTP,Phoenix,Elixir,Svelte,Phoenix', 'https://github.com/diderikk/Chess', 'https://chess.diderikk.dev', 'https://github.com/diderikk/Chess/blob/master/README.md'), 
('7730319e-38ec-4547-87aa-464498af92a7', 'SimpleChat web application', 'SimpleChatApp is a full-stack application that uses Elixir/Phoenix as an API framework. This app allows users to sign up, sign in, create new chats, and invite other users. However, there is currently no method for inviting users to existing chats, which needs to be implemented. Chatting is possible through Phoenix Channels and WebSockets, and users must be authorized to enter a chat.', '/70fa446d6596731fdfa30f73647f4118eedfa3d78492a25f400986d6cc072e5c.png', 'WebSocket,ChakraUI,TypeScript,React,Phoenix,Elixir', 'https://github.com/diderikk/SimpleChatApp', 'https://chat.diderikk.dev', 'https://github.com/diderikk/SimpleChatApp/blob/master/README.md'), 
