...
int poll_array_test() {
  ...
  poll_array_start_case(remove_poll_fd_by_index_sync_test,
                        "remove_poll_fd_by_index_sync_test");
  poll_array_start_case(add_poll_fd_sync_overflow_test,
                        "add_poll_fd_sync_overflow_test");
  poll_array_start_case(add_poll_fd_sync_overflow_minus_one_after_last_test,
                        "add_poll_fd_sync_overflow_minus_one_after_last_test");
  poll_array_start_case(add_poll_fd_sync_overflow_minus_one_before_last_test,
                        "add_poll_fd_sync_overflow_minus_one_before_last_test");
  poll_array_start_case(add_poll_fd_sync_overflow_minus_all,
                        "add_poll_fd_sync_overflow_minus_all");
  poll_array_start_case(add_poll_fd_sync_overflow_minus_even,
                        "add_poll_fd_sync_overflow_minus_even");
