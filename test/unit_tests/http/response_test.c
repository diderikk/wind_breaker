...
void* construct_response_ok_test() {
    ...
    size_t response_size = construct_response(http_response, uri, "", "", response, body_size, tmp);
...
void* construct_response_ok_with_compression_test() {
    ...
    size_t response_size = construct_response(http_response, uri, "gzip", "", response, body_size, tmp);
...
void* construct_response_not_modified_test() {
    ...
    unsigned int buff_size = read_static_file("index.html", response, REQUEST_RESPONSE_MAX_SIZE);
    ...
    size_t response_size = construct_response(http_response, uri, "gzip", etag, response, buff_size, tmp);
