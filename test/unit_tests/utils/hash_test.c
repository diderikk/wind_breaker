...
void *sha256_hash_hex_long_string_test() {
  const char *input_data =
      "This is a longer test string to check the SHA256 hash function.";
  size_t input_size =
  ...
  assert(
      strcmp(
          outputBuffer,
          "15198daf542067e15f9b6ada822e9fd238b631d86a708ead9e14489c7f72bc7a") ==
      0);
...
void *sha256_hash_hex_binary_data_test() {
  const unsigned char input_data[] = {0xde, 0xad, 0xbe, 0xef,
                                      0x00, 0x01, 0x02, 0x03};
  ...
  int result =
      sha256_hash_hex((const char *)input_data, input_length, outputBuffer);

  assert(result == SHA256_DIGEST_LENGTH * 2 + 1);
  assert(
      strcmp(
          outputBuffer,
          "60f124171b44e2c7ea54510ed698727dfba5da38715ed8b255775c7b30afe7f6") ==
      0);
...
int hash_test() {
  ...
  hash_start_case(sha256_hash_hex_empty_input_test,
                  "sha256_hash_hex_empty_input_test");
  hash_start_case(sha256_hash_hex_short_string_test,
                  "sha256_hash_hex_short_string_test");
  hash_start_case(sha256_hash_hex_long_string_test,
                  "sha256_hash_hex_long_string_test");
  hash_start_case(sha256_hash_hex_binary_data_test,
                  "sha256_hash_hex_binary_data_test");
